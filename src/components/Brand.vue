...
<template>
  <section
    id="brand"
    class="min-h-screen relative overflow-hidden bg-linear-to-br from-[#652BDF] to-[#874fff] md:from-[#874fff] md:to-[#652BDF]">
    <!-- 배경 장식 요소
    ...
    <!-- 메인 컨텐츠 -->
    <div class="container mx-auto px-4 min-h-screen flex items-center justify-center pt-15 md:pt-40">
      <div class="flex flex-col items-center text-center w-full max-w-6xl">
        <!-- 텍스트 영역 -->
        <!-- md일 때만 표시되는 p 태그 -->
        <p class="block md:hidden text-[#cbb2ff] font-bold text-lg mb-3">2024년 12월 출시</p>
        <div
          ...
          <img class="h-8 md:h-15 mb-12" src="/images/logo.png" alt="logo" />

          <!-- 다운로드 버튼 -->
          <button
            class="inline-flex items-center gap-2 px-6 py-3 bg-transparent border-2 border-white text-white rounded-full hover:bg-white hover:text-purple-600 transition-all duration-300 text-[15px] md:text-base font-medium"
